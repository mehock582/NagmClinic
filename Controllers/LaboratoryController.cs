        ...
        public async Task<IActionResult> GetLabResultsData()
        {
            try
            {
                ...
                var data = await query
                    ...
                    {
                        lr.Id,
                        DailyNumber = lr.AppointmentItem.Appointment != null ? lr.AppointmentItem.Appointment.DailyNumber.ToString() : "-",
                        AppointmentDate = lr.AppointmentItem.Appointment != null ? lr.AppointmentItem.Appointment.AppointmentDate.ToString("yyyy-MM-dd HH:mm") : "-",
                        PatientName = lr.AppointmentItem.Appointment.Patient != null ? lr.AppointmentItem.Appointment.Patient.FullName : "غير معروف",
                        PatientPhone = lr.AppointmentItem.Appointment.Patient != null ? lr.AppointmentItem.Appointment.Patient.PhoneNumber : "-",
                        DoctorName = lr.AppointmentItem.Appointment.Doctor != null ? lr.AppointmentItem.Appointment.Doctor.NameAr : "",
                        TestName = lr.AppointmentItem.Service != null ? lr.AppointmentItem.Service.NameAr : "-",
                        ResultType = lr.AppointmentItem.Service != null ? (int)lr.AppointmentItem.Service.ResultType : 0,
                        PredefinedValues = lr.AppointmentItem.Service != null ? lr.AppointmentItem.Service.PredefinedValues : "",
